...
export const chunkText = (text, chunkSize = 500, overlap = 50) => {
  ...
  for (const paragraph of paragraphs) {
    ...
    // if adding this paragraph exceeds chunk size, save a new chunk
 ...
 // Fallbacks: if no chunks created, split by words
...
/**
 * Find revelant chunks based on keyboard matching
...
export const findRelevantChunks = (chunks, query, maxChunks = 3) => {
    ...
    if (queryWords.length === 0) {
        ...
        const scoreChunks = chunks.map((chunk, index) => {
            ...
            //Return clean object without mongoos data
            return{
                content: chunk.content,
                chunkIndex: chunk.chunkIndex,
                pageNumber: chunk.pageNumber,
