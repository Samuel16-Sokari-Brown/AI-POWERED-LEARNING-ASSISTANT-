...
O3: [Option 3]
O4: [Option 4]
C: [Exactly the full text of the correct option. Do NOT write O1/O2/O3/O4.]
E: [Brief explanation]
...
export const generateSummary = async (text) => {
    const prompt = `Provide a comprehensive summary of the following document. Make it easy to read and understand.
